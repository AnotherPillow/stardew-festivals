...
import flowerdance_setup_2_vanilla from "./setup-vanilla-2";

const flowerdance_setup_2_sve = supplement([
    {
        "displayName": "Aymeric",
        "internalID": "Aymeric",
...
], flowerdance_setup_2_vanilla)

export default flowerdance_setup_2_sve