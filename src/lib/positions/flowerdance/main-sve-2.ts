...
import flowerdance_main_2_vanilla from "./main-vanilla";

const flowerdance_main_2_sve = supplement([
    {
        "displayName": "Aymeric",
        "internalID": "Aymeric",
...
], flowerdance_main_2_vanilla)

export default flowerdance_main_2_sve